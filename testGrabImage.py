...
def paizhao(name_photo,key = 1,photo_num = 1):
    ...
    #cam.MV_CC_SetFloatValue("ExposureTime",float(17200))
    ...
    if ret == 0:
        ...
        #保存的路径
        if key == 1:
            file_path = "E:/photo/" + name_photo + ".jpg"
        elif key == 2:
            file_path = "E:/photo/p" + str(photo_num) + "/" + name_photo + ".jpg"
        else:
            file_path = "E:/photo_test/" + name_photo + ".jpg"
...
paizhao('123123')
time.sleep(0.5)
value = ewm_and_lcd.erweima_shibei('E:/photo/123123.jpg')
if value == 'shibai':
    print('shibai_1')
    time.sleep(1)
    paizhao('123123')
    time.sleep(0.5)
    value = ewm_and_lcd.erweima_shibei('E:/photo/123123.jpg',140)
